    ...
    <t-row :gutter="16">
      <t-col :span="8">
        ...
        >
          <div
            class="mediumn"
            style="color: rgb(20, 21, 34); font-family: Poppins; font-size: 24px; font-weight: 600"
          >
            进行中的任务
          </div>
          <t-space>
        ...
        <t-row :gutter="16">
          <t-col :span="6">
            <t-card>
              <t-image
                src="http://pic.lvmama.com/uploads/pc/place2/2017-11-24/19e96e3c-ba34-4dc4-8b17-62b3aa595cf9.jpg"
      ...
      <t-col :span="4">
        <t-card>
          ...
          <user-card
            ...
            :status="0"
            avatar-url="https://avatars.githubusercontent.com/Wen1kang"
          ></user-card>
          <t-row
            justify="center"
            style="margin-top: 15p"
          >
            <t-space>
        ...
        <t-card title="今日任务推荐">
          ...
          >
            <t-avatar
              size="40px"
              image="https://avatars.githubusercontent.com/Wen1kang"
            ></t-avatar>
