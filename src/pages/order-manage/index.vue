<template>
  <div>
      ...
      <view style="display: grid">
        ...
        <view style="display: flex; justify-content: center">
          ...
          <view style="width: 400px; margin-left: 20px; margin-right: 20px">
            <t-select v-model="menusChoose" placeholder="无">
      ...
      <div v-if="excelBookId != ''">
        <div style="margin-top: 20px; display: flex; justify-content: center">
          <t-upload v-model="excel" action="/manager/manager/book/uploadWordByExcel" theme="file" :draggable="draggable"
            :headers="{ accessToken: accessToken }" :max="2" :auto-upload="false" :data="{ bookId: excelBookId }"
    ...
    <t-dialog key="11" v-model:visible="visibleNewWord" width="1000px" theme="info" header="新增单词" :footer="false"
      @close="newWordClose()">
      <div style="display: flex; justify-content: center; margin-bottom: 20px">
      ...
      <div style="display: flex; justify-content: center; margin-bottom: 10px">
        <t-link theme="primary" @click="visibleWordAdd = true">没有搜索到想要添加的单词？点击这里添加</t-link>
      </div>
    ...
    <t-dialog v-model:visible="visibleMenus" width="800px" theme="info" header="新增一级目录" :footer="false"
    ...
    <t-dialog v-model:visible="visibleMenusList" width="900px" theme="info" header="修改/删除一级目录" :footer="false"
    ...
    <t-dialog v-model:visible="visibleBatch" width="1100px" theme="info" header="批量上传文件" :footer="false"
      ...
      <view style="display: flex; justify-content: center; color: red; font-size: 12px">注：清空表格并不会删除已上传文件，请谨慎操作</view>
