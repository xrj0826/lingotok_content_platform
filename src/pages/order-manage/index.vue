<template>
  <div>
    ...
    <t-dialog
      v-model:visible="visibleWordAdd"
      width="800px"
      theme="info"
      header="自定义添加单词"
      :footer="false"
    ...
    >
      ...
      <div v-if="data6">
        ...
        <div v-else>
          <div style="display: flex; justify-content: center">
            <img
              src="https://stickyfinger.oss-cn-guangzhou.aliyuncs.com/null5dc984f6d7d2418abc61ea0890fc81b0.png"
      ...
      <div v-if="data6">
        <div v-if="data6.phrase">
          <t-table
            :row-key="index"
            :data="data6.phrase.phrases"
            :columns="columnsPrase"
            resizable
            table-layout="fixed"
            :bordered="true"
            size="small"
      ...
      <div v-if="keyWord == 2">
        <div v-if="data6.sentence.sentences[arrIndex]">
          ...
          <div style="display: flex; margin-top: 20px">
            ...
            <t-input
              v-model="data6.sentence.sentences[arrIndex].scn"
              :style="{ width: '600px' }"
              placeholder="请输入单词"
            />
          </div>
      ...
      <div v-if="keyWord == 3">
        <div v-if="data6.trans[arrIndex]">
          <div style="display: flex">
            <div style="line-height: 30px; margin-right: 20px">翻译：</div>
            <t-input
              v-model="data6.trans[arrIndex].tranCn"
              :style="{ width: '600px' }"
              placeholder="请输入单词"
            />
          </div>
      ...
      <div v-if="keyWord == 4">
        <div v-if="data6.phrase.phrases[arrIndex]">
          <div style="display: flex">
            ...
            <t-input
              v-model="data6.phrase.phrases[arrIndex].pcontent"
              :style="{ width: '600px' }"
              placeholder="请输入单词"
            />
          </div>
          <div style="display: flex; margin-top: 20px">
            <div style="line-height: 30px; margin-right: 20px">翻译：</div>
            <t-input
              v-model="data6.phrase.phrases[arrIndex].pcn"
              :style="{ width: '600px' }"
              placeholder="请输入单词"
            />
          </div>
      ...
      <div v-if="keyWord == 5">
        <div v-if="data6.syno.synos[arrIndex]">
          <div style="display: flex">
            ...
            <t-input
              v-model="data6.syno.synos[arrIndex].pos"
              :style="{ width: '100px' }"
              placeholder="请输入单词"
            />
          </div>
          <div style="display: flex; margin-top: 20px">
            ...
            <t-input
              v-model="data6.syno.synos[arrIndex].tran"
              :style="{ width: '460px' }"
              placeholder="请输入单词"
            />
          </div>
    ...
    >
      <div v-if="modifyBool == 1">
        ...
        <div style="display: flex; margin-top: 10px">
          ...
          <t-input
            v-model="relWord1.pos"
            :style="{ width: '400px' }"
          ></t-input>
          <div
            v-if="showPos"
            style="font-size: 14px; color: red; line-height: 28px; margin-left: 10px"
          >
            *请填写分类
          </div>
        </div>
    ...
    >
      ...
      <div style="width: 400px; margin: 0 auto">
        <t-textarea
          v-model="bookDescription1"
          placeholder="请输入词汇书描述"
    ...
    <t-dialog
      ...
      v-model:visible="visibleResource"
      width="800px"
      theme="info"
      header="单词资源修改"
      :footer="false"
      @close="closeModifyWord"
    >
      <!-- <video src=""></video> -->
      ...
      <div style="border: 2px solid #82a0cf; border-radius: 25px; margin-top: 30px">
        ...
        <div style="display: flex; justify-content: center; margin-top: 10px">
          <t-upload
            ...
            accept="audio/*"
            @onWaitingUploadFilesChange="console.log('发生变化')"
            @success="handleuploadAudioUs"
            @remove="removeAudioUs"
            @validate="repite"
          ></t-upload>
        </div>
        <div style="display: flex; justify-content: center; margin-top: 10px; margin-bottom: 10px">
          <audio
            :src="resourceAudioUs.url"
            controls
          ></audio>
        </div>
      ...
      <div style="border: 2px solid #82a0cf; border-radius: 25px; margin-top: 30px">
        ...
        <div style="display: flex; justify-content: center; margin-top: 10px">
          <t-upload
            ...
            accept="audio/*"
            @onWaitingUploadFilesChange="console.log('发生变化')"
            @success="handleuploadAudioUk"
            @remove="removeAudioUk"
            @validate="repite"
          ></t-upload>
        </div>
        <div style="display: flex; justify-content: center; margin-top: 10px; margin-bottom: 10px">
          <audio
            :src="resourceAudioUk.url"
            controls
          ></audio>
        </div>
        <div style="height: 10px"></div>
    ...
    <t-dialog
      v-model:visible="visibleModifyMenus"
      width="800px"
      theme="info"
      header="修改一级目录"
      :footer="false"
