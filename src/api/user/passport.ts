...
export async function getByCondition(
  ...
  return request<API.ResultMessageIPageAdminUserVO>('/manager/passport/user', {
    method: 'GET',
    params: {
      ...params,
      user: undefined,
...
export async function register(
  ...
  return request<API.ResultMessageObject>('/manager/passport/user', {
    method: 'POST',
    headers: {
...
export async function delAllByIds2(
  ...
  return request<API.ResultMessageObject>(`/manager/passport/user/${param0}`, {
    method: 'DELETE',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function edit2(
  ...
  return request<API.ResultMessageObject>('/manager/passport/user/admin/edit', {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function editOwner(
  ...
  return request<API.ResultMessageObject>('/manager/passport/user/edit', {
    method: 'PUT',
    params: {
      ...params,
      adminUser: undefined,
...
export async function editPassword(
  ...
  return request<API.ResultMessageObject>('/manager/passport/user/editPassword', {
    method: 'PUT',
    params: {
      ...params,
    },
...
export async function disable(
  ...
  return request<API.ResultMessageObject>(`/manager/passport/user/enable/${param0}`, {
    method: 'PUT',
    params: {
      ...queryParams,
    },
...
export async function getUserInfo(options?: { [key: string]: any }) {
  return request<API.ResultMessageAdminUser>('/manager/passport/user/info', {
    method: 'GET',
    ...(options || {}),
  });
}
...
export async function login(
  ...
  return request<API.ResultMessageToken>('/manager/passport/user/login', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function logout(options?: { [key: string]: any }) {
  return request<API.ResultMessageObject>('/manager/passport/user/logout', {
    method: 'POST',
    ...(options || {}),
  });
}
...
export async function refreshToken(
  ...
  return request<API.ResultMessageObject>(`/manager/passport/user/refresh/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
...
export async function resetPassword(
  ...
  const { ids: param0, ...queryParams } = params;
  return request<API.ResultMessageObject>(`/manager/passport/user/resetPassword/${param0}`, {
    method: 'POST',
    params: { ...queryParams },
    ...(options || {}),
  });
